...
export default function GuardianLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: '/guardian/area-intelligence', icon: BrainCircuit, label: 'Area Intelligence' },
    { href: '/guardian/reports', icon: FileText, label: 'Reports' },
    { href: '/guardian/cases', icon: Briefcase, label: 'Cases' },
    { href: '/guardian/ngo-network', icon: Building2, label: 'NGO Network' },
    { href: '/guardian/volunteers', icon: Users, label: 'Guardian Network' },
    { href: '/guardian/analytics', icon: BarChart2, label: 'Analytics' },
    { href: '/guardian/organization', icon: Building2, label: 'Organization' },
